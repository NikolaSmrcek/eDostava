...
<body>
  ...
  <div class='navbar-header'>
    ...
    <span class='navbar-brand' >Dobrodošli {$ime}  &nbsp  {$prezime} </span>
  </div>
  ...
  <div class='collapse navbar-collapse' id='bs-example-navbar-collapse-1'>
    <ul class='nav navbar-nav navbar-right'>
      ...
      {$var}
      <li class='dropdown'>
        <a href='#' class='dropdown-toggle' data-toggle='dropdown'><strong> {if isset($kor)} {$kor} {else} Odabir {/if} </strong> <b class='caret'></b></a>
